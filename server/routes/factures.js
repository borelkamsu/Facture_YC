...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .invoice-num { color: #640000; font-size: 15px; font-weight: 700; margin-top: 4px; }
    ...
    .ref-badge {
      background: #fde8e8; color: #640000;
    ...
    .notes-label { font-size: 10px; font-weight: 700; text-transform: uppercase; color: #640000; margin-bottom: 4px; letter-spacing: 1px; }
