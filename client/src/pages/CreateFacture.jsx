  ...
  return (
    <div className="p-4 md:p-6 max-w-5xl mx-auto pb-8">
        ...
        <div>
          <div className="flex items-center gap-2.5 mb-0.5">
            <div className="w-8 h-8 md:w-9 md:h-9 bg-[#640000]/10 rounded-xl flex items-center justify-center">
              <FileText size={16} className="text-[#640000]" />
            </div>
            <div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 mb-4 overflow-hidden">
        <div className="px-4 md:px-5 py-3.5 border-b border-slate-100 flex items-center justify-between bg-slate-50/60">
          ...
          <button onClick={() => setLignes(p => [...p, emptyLigne()])}
            className="flex items-center gap-1.5 text-[#640000] hover:text-[#8a0d0d] bg-[#640000]/10 hover:bg-[#640000]/20 px-3 py-2 rounded-xl text-xs font-semibold transition-all">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-4 md:p-6 mb-6">
        <div className="flex justify-end">
          <div className="w-full md:w-80 space-y-2">
            ...
            <div className="bg-[#640000] rounded-xl px-4 py-3 flex justify-between items-center mt-2">
      ...
      <div className="flex justify-end gap-3">
        ...
        <button onClick={handleSave} disabled={saving}
          className="flex items-center gap-2 bg-[#640000] hover:bg-[#8a0d0d] text-white px-6 md:px-8 py-2.5 rounded-xl font-semibold text-sm shadow-lg shadow-[#640000]/25 disabled:opacity-50">
          <Save size={15} />
